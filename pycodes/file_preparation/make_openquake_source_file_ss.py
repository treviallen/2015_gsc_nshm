...
from numpy import log10, max, min, tan, radians, unique, isinf
...
single_src = argv[4] # source code of interest
                ...
                #######################################################################
                    ...
                    if isinf(log10(m['src_N0'][i])) == False:
                        ...
                        if m['fault_dip'][0] != m['fault_dip'][1]:
                            ...
                            newxml += '        <complexFaultSource id="'+m['src_code']+idsub+'" name="'+\
                                       m['src_name']+'" tectonicRegion="'+tectonic_reg+'">\n'
